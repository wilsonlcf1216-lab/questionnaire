...
export function ItemCard({
  ...
  return (
    <article className="overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-sm">
        ...
        <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <h3 className="font-display text-[30px] leading-tight text-slate-950">{item.element}</h3>
              <div className="max-w-4xl rounded-[20px] border border-teal-100 bg-[#f8fffd] p-4 sm:p-5">
          ...
          <div className="w-full max-w-[220px] rounded-[20px] border border-slate-200 bg-[#f7f7f4] p-4">
      ...
      {isFail ? (
        <div className="space-y-4 border-t border-slate-200 bg-[#f5f5f1] px-5 py-5 sm:px-6">
          ...
          <div className="space-y-4 rounded-[22px] border border-slate-200 bg-white p-4 sm:p-5">
            ...
            <div className="space-y-4">
              {defectRows.map((row, index) => (
                <div key={row.id} className="rounded-[20px] border border-slate-200 bg-[#f8f8f5] p-4">
                  ...
                  <div className="grid gap-4 xl:grid-cols-[minmax(0,1.2fr)_minmax(240px,1fr)_minmax(240px,1fr)]">
